...
#define BHOP_UTILS_INTERFACE "BhopUtilsInterface"

// Expose some of the utility functions to other plugins.
class BhopUtils
{
public:
	BhopUtils(GetLegacyGameEventListener_t *GetLegacyGameEventListener, SnapViewAngles_t *SnapViewAngles, EmitSoundFunc_t *EmitSound,
