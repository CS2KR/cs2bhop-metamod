...
public:
	...
	void AddAllPlayers(void)
	{
		...
		for (int i = 0; i < g_pBhopUtils->GetClientList()->Count(); i++)
		{
			if (g_pBhopUtils->GetClientList()->Element(i)->IsInGame())
			{
				AddRecipient(g_pBhopUtils->GetClientList()->Element(i)->GetPlayerSlot());
			}
		}
	}
