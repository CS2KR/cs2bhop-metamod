...
class Bhop102tModePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
public:
	...
	const char *GetName()
	{
		return "CS2Bhop-Mode-102tick";
	}

	const char *GetDescription()
	{
		return "102tick mode plugin for CS2Bhop";
	}
...
class Bhop102tModeService : public BhopModeService
{
