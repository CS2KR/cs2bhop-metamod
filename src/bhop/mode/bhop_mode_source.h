...
class BhopSourceModePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
public:
	...
	{
		return "CSS-style 66tick mode plugin for CS2Bhop";
	}
...
class BhopSourceModeService : public BhopModeService
{
