...
public:
	static void PrintUsage(BhopPlayer *player);

	void FilterAndPrintMatchingCheaterReplays(ReplayFilterCriteria &criteria, BhopPlayer *player);
	void FilterAndPrintMatchingRunReplays(ReplayFilterCriteria &criteria, BhopPlayer *player);
	void FilterAndPrintMatchingManualReplays(ReplayFilterCriteria &criteria, BhopPlayer *player);

	void FindReplaysMatchingCriteria(const char *inputs, BhopPlayer *player);
