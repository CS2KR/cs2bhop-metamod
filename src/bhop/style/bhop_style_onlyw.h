...
#define STYLE_NAME       "OnlyW"
#define STYLE_NAME_SHORT "OW"

class BhopOnlyWStylePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
public:
	...
	const char *GetName()
	{
		return "CS2Bhop-Style-OnlyW";
	}

	const char *GetDescription()
	{
		return "OnlyW style plugin for CS2Bhop";
	}
...
class BhopOnlyWStyleService : public BhopStyleService
{
