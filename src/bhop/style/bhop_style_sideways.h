...
#define STYLE_NAME       "Sideways"
#define STYLE_NAME_SHORT "SW"

class BhopSidewaysStylePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
public:
	...
	const char *GetName()
	{
		return "CS2Bhop-Style-Sideways";
	}

	const char *GetDescription()
	{
		return "Sideways style plugin for CS2Bhop";
	}
...
class BhopSidewaysStyleService : public BhopStyleService
{
