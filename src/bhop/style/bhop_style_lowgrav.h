...
class BhopLowGravStylePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
public:
	...
	const char *GetName()
	{
		return "CS2Bhop-Style-LowGrav";
	}

	const char *GetDescription()
	{
		return "Low Grav style plugin for CS2Bhop";
	}
...
class BhopLowGravStyleService : public BhopStyleService
{
