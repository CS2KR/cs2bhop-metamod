...
void Bhop::misc::EnforceTimeLimit()
{
...
void Bhop::misc::UnrestrictTimeLimit()
{
	if (!cvarLoaded)
	{
		return;
...
void Bhop::misc::InitTimeLimit()
{
	mp_timelimit.Set(BhopOptionService::GetOptionFloat("defaultTimeLimit", 60.0f));
}
